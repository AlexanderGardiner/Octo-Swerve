...
public class SparkMaxStatusFrames {
    ...
    * @param periodicStatus1 Motor Velocity, Motor Temperature, Motor Voltage, Motor Current
    * @param periodicStatus2 Motor Position
    * @param periodicStatus3 Analog Sensor Voltage, Analog Sensor Velocity, Analog Sensor Position
    * @param periodicStatus4 Alternate Encoder Velocity, Alternate Encoder Position
    * @param periodicStatus5 Duty Cycle Absolute Encoder Position, Duty Cycle Absolute Encoder Absolute Angle
    * @param periodicStatus6 Duty Cycle Absolute Encoder Velocity, Duty Cycle Absolute Encoder Frequency
    */
