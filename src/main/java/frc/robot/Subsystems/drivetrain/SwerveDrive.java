...
public class SwerveDrive extends SubsystemBase {
    ...
    private double maxAngularSpeed = 3 * Math.PI;
    ...
    public SwerveDrive() {
        this.driveTrain = new DriveTrain(
                MotorType.SparkMax,
                MotorType.TalonFX,
                new int[] { MotorIDs.FRONT_LEFT_STEER, MotorIDs.FRONT_RIGHT_STEER, MotorIDs.BACK_LEFT_STEER,
                ...
                40.0 / 11.0,
                0.038,
                new Translation2d[] { new Translation2d(-0.3175, 0.31), new Translation2d(0.3175, 0.31),
                        new Translation2d(-0.3175, -0.31),
                        new Translation2d(0.3175, -0.31) },
