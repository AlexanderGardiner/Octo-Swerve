...
public enum Animations {
    ...
    //change
    COMMAND_ACTIVE(new StrobeAnimation(255, 255, 255, 0, 0, 60), 0),

    CHECK_FAILED(new StrobeAnimation(255, 0, 0, 0, 0, 60), 0.1),
    CHECK_PASSED(new StrobeAnimation(0, 255, 0, 0, 0, 60), 0.1),
    ...
    ID_YELLOW(new StrobeAnimation(255, 255, 0, 0, 0, 60), 0.08),
    ID_GREEN(new StrobeAnimation(0, 255, 0, 0, 0, 60), 0.08),
    ID_BLUE(new StrobeAnimation(0, 0, 255, 0, 0, 60), 0.08),
    ID_PURPLE(new StrobeAnimation(255, 0, 255, 0, 0, 60), 0.08);
